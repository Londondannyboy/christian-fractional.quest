 ...
 */
export function createVoiceMiddleware(name: string, hooks: VoiceMiddlewareHooks): VoiceMiddleware {
  return { name, hooks }
}
 ...
 */
export function combineVoiceMiddleware(...middlewares: VoiceMiddleware[]): VoiceMiddlewareHooks {
