...
import { createVoiceAgent } from "../../core/src/index.js";
import { AssemblyAISpeechToText } from "../../provider/assemblyai/src/index.js";
import { ElevenLabsTextToSpeech } from "../../provider/elevenlabs/src/index.js";
import { HumeTextToSpeech } from "../../provider/hume/src/index.js";
import { OpenAISpeechToText, OpenAITextToSpeech } from "../../provider/openai/src/index.js";
...
export function createSandwichShopVoiceAgent(params: CreateVoiceAgentParams) {
  ...
  console.log(`Creating voice agent with STT: ${providers.sttProvider}, TTS: ${providers.ttsProvider}`);
